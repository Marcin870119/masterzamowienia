...
function showVirtualEditModal(productIndex) {
  try {
    ...
    canvas.on('object:selected', (e) => {
      ...
      editPanel.style.display = obj.type === 'text' ? 'block' : 'none'; // Pokazuj panel tylko dla tekstu
      ...
      window.applyTextEdit = function() {
        try {
          ...
          if (obj.type === 'text') {
            ...
            const wrappedText = wrapText(textContent, maxWidth, fontSize, fontFamily, canvas);
            obj.set({
