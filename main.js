...
function applyFilters() {
    ...
    if (sortOrder && productsData[activeTab].length > 0) {
        ...
        // Ponowne renderowanie po sortowaniu
        productList.innerHTML = '';
    ...
    products.forEach(product => {
        ...
        // Lepsza normalizacja kategorii
        const normalizeString = (str) => str
            .toLowerCase()
            .replace(/[\s-]+/g, ' ') // Zamiana myślników i wielokrotnych spacji na pojedynczą spację
            .trim();
        ...
        console.log("Filter Debug - Index:", productIndex, "Category:", productCategory, "Normalized Category:", normalizedProductCategory, "Selected:", selectedCategory, "Normalized Selected:", normalizedSelectedCategory, "Match:", categoryMatch); // Debug

        if (searchMatch && categoryMatch) {
            product.style.display = 'block'; // Używamy display zamiast visibility dla lepszej wydajności
            product.style.position = 'relative';
        } else {
            product.style.display = 'none'; // Ukrywamy elementy zamiast zmieniać visibility
